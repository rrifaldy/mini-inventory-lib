...
$sql = $pdo->prepare("INSERT INTO tb_barang_masuk(id_barang, nama_barang, kategori_barang, harga_barang, jumlah_barang, datetime1) VALUES(:id_barang, :nama_barang, :kategori_barang, :harga_barang, :jumlah_barang, :datetime1)");
...
if($sql){
    ...
    echo "<br><a href='addBarangMasuk.php'>Kembali Ke Form</a>";
}
?>