...
<body>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <?php
            ...
            $sql = $pdo->prepare("SELECT * FROM tb_barang_keluar WHERE id_transaksi=:id_transaksi");
            $sql->bindParam(':id_transaksi', $id_transaksi);
            $sql->execute();
            $data = $sql->fetch();
        ?>

        <form method="post" action="prosesUbahKeluar.php?id_transaksi=<?php echo $id_transaksi; ?>">
            <div class="mb-3">
