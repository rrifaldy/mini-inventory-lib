...
$sql = $pdo->prepare("UPDATE tb_barang_masuk SET nama_barang=:nama_barang, kategori_barang=:kategori_barang, harga_barang=:harga_barang, jumlah_barang=:jumlah_barang, datetime1=:datetime1 WHERE id_transaksi=:id_transaksi");
